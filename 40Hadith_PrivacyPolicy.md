## 40 Hadiths An-Nawawi: Privacy policy

Welcome to the 40 Hadiths An-Nawawi app for Android!

This is an open source Android app developed by AIndie Apps. The source code is available on GitHub under the GNU AGPL license (3.0 or later).
